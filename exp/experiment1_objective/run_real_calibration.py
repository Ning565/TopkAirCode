...
FULL_SYSTEM_DIR = ROOT / "exp" / "full_system"
sys.path.insert(0, str(FULL_SYSTEM_DIR))
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="exp/experiment1_objective/final_real")
    parser.add_argument("--dataset", default="femnist", choices=["mnist", "femnist"])
    parser.add_argument("--methods", default="topk,randk,full")
    parser.add_argument("--ratios", default="0.01,0.02,0.05,0.1,0.2,0.35,0.5,0.8,1.0")
