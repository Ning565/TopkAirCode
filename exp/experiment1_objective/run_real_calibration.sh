...
OUT_DIR="${OUT_DIR:-exp/experiment1_objective/final_real}"
LOG_DIR="${LOG_DIR:-exp/experiment1_objective/logs}"
...

{
  ...
  "${PYTHON_BIN}" exp/experiment1_objective/run_real_calibration.py --output-dir "${OUT_DIR}" "$@"
