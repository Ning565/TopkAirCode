...
RATIOS="${RATIOS:-0.10,0.12,0.15,0.20,0.35,0.50,0.65,0.80}"
EPSILON="${EPSILON:-3e8}"
SIGMA0="${SIGMA0:-0.03}"
P_MAX="${P_MAX:-1e3}"
...
RUN_TAG="${RUN_TAG:-common_grid_seed${SEED}_r${ROUNDS}_$(date +%Y%m%d_%H%M%S)}"
LOG_DIR="${LOG_DIR:-logs/experiments/exp2.0-onlinesearch/common_grid}"
...
echo "Started experiment-2 shared-ratio comparison"
echo "  pid: $PID"
echo "  log: $LOG_FILE"
echo "  out: $OUT_DIR"
echo "  cmd: $CMD_FILE"
